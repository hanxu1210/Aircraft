...
if [ -d "${TARGET_ROOT}" ]; then
    ...
    # Combin ForAssets directory to the assets directory of game project
    GAME_ASSETS_DIR="${GAME_PROJECT_DIR}"/../Resources
    ${SHELL_DIR}/modifyAssets.sh "${GAME_ASSETS_DIR}"
    
    # Combin CLibs directory to the libs directory of game project
    GAME_LIBS_DIR="${GAME_PROJECT_DIR}"/jni/prebuild
    ${SHELL_DIR}/modifyLibs.sh "${GAME_LIBS_DIR}"
