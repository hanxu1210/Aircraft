...
- (NSURL *)ratingsURL
{
    ...
    return [NSURL URLWithString:[NSString stringWithFormat:([[UIDevice currentDevice].systemVersion floatValue] >= 7.0f)? iLinkiOS7AppStoreURLFormat: iLinkiOSAppStoreURLFormat, @(self.appStoreID)]];
...
- (NSURL *)appLocalURL
{
    ...
    // itms-apps
    return [NSURL URLWithString:[NSString stringWithFormat: iLinkiOS7AppStoreURLFormat, @(self.appStoreID)]];
...
- (NSURL *)appLocalURLWithAppStoreID:(NSUInteger)appStoreIDofApp
{
    ...
    // itms-apps
    return [NSURL URLWithString:[NSString stringWithFormat: iLinkiOS7AppStoreURLFormat, @(appStoreIDofApp)]];
